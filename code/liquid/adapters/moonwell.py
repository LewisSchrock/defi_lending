...
# LiquidateBorrow event ABI (Compound-style)
...
class MoonwellLiquidationAdapter(LiquidationAdapter):
    """
    Liquidation adapter for Moonwell lending on Base (Compound v2 fork).
    """
    ...
    def __init__(self, web3: Web3, chain: str, config: Dict[str, Any], outputs_dir: str):
        ...
        self.comptroller_address = Web3.to_checksum_address(
            config.get("comptroller", MOONWELL_COMPTROLLER)
        )
    ...
    def normalize(self, raw_event: Any) -> Dict[str, Any]:
        ...
        return {
            ...
            "chain": self.chain,
            "ctoken_emitter": Web3.to_checksum_address(mtoken_address),
