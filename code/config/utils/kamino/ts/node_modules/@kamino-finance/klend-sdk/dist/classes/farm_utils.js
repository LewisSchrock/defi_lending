...
exports.FARMS_ADMIN_MAINNET = exports.FARMS_GLOBAL_CONFIG_MAINNET = void 0;
 ...
 */
async function getUserPendingRewardsInFarm(rpc, userStateAddress, farm) {
    ...
    const farmState = await farms_sdk_1.FarmState.fetch(rpc, farm);
    if (!farmState) {
