...
import { AddAssetToMarketParams, AllOracleAccounts, CreateKaminoMarketParams, ENV, KaminoMarket, KaminoReserve, LendingMarket, MarketWithAddress, Reserve, ReserveWithAddress, ScopeOracleConfig } from '../lib';
...
export declare class KaminoManager {
     ...
     */
    updateVaultConfigIxs(vault: KaminoVault, mode: VaultConfigFieldKind | string, value: string, signer?: TransactionSigner, lutIxsSigner?: TransactionSigner, skipLutUpdate?: boolean): Promise<UpdateVaultConfigIxs>;
     ...
     */
    getVaultDelegatedFarmRewardsAPY(vault: KaminoVault, vaultTokenPrice: Decimal, farmsClient?: Farms, slot?: Slot): Promise<FarmIncentives>;
    /**
