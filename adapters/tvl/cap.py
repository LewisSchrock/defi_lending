...
def get_cap_tvl(
    ...
    try:
        # Get vault state
        # Yearn V3 vault: totalAssets = totalIdle + totalDebt
        # totalDebt = capital deployed to strategies (lent out)
        # totalIdle = undeployed capital sitting in vault
        ...
        # totalDebt = borrowed/deployed capital, totalIdle = available liquidity
        return [{
            'vault': vault_address,
            ...
            'total_borrowed_raw': total_debt,
            'available_liquidity_raw': total_idle,
        }]
