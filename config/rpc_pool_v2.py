...
|------------|-------------------|---------------|------------------|----------|
| Alchemy    | 30M CU/acct       | 300 CU/sec    | 60 CU            | Primary  |
| BlockPi    | 50M RU/31 days    | 400 RU/sec    | 75 RU            | Primary  |
| NodeReal   | 100M CU/month     | 150 CU/sec    | 75 CU            | Primary  |
| Ankr       | 200M credits/mo   | ~30 req/sec   | ~100 credits     | Secondary|
| Infura     | 3M credits/day    | 500 cred/sec  | HIGH             | Fallback |
| Public     | No limit          | ~5-10 req/sec | N/A              | Last     |

Strategy:
- Primary: Rotate across Alchemy, BlockPi, NodeReal for eth_getLogs
- Secondary: Ankr for overflow
- Fallback: Infura (daily cap), Public RPCs
